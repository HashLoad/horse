...
procedure DoApiPing(Req: THorseRequest; Res: THorseResponse; Next: TNextProc);
begin
  Res.Send('Pong da API Publica (Instancia 1)');
end;

procedure DoAdminPing(Req: THorseRequest; Res: THorseResponse; Next: TNextProc);
begin
...
begin
  ...
  FInstance1.Get('/api/v1/ping', DoApiPing);
