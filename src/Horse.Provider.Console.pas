...
{$IF NOT DEFINED(FPC)}
uses Horse.Provider.Abstract, Horse.Constants, Horse.Provider.IOHandleSSL.Contract,
  Horse.Provider.IOHandleSSL, IdHTTPWebBrokerBridge, IdSSLOpenSSL, IdSSL, IdContext,
